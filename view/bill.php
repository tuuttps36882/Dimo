...
<div class="container__cart__first">
    ...
    <div class="container__cart__first__pay">
        ...
        if (isset($_SESSION['name_user'])) {
            ...
            $address_user = $_SESSION['address_user'];
            $phoneNumber_user = $_SESSION['phoneNumber_user'];
        ...
        <div class="form-container">
            <form method="POST" action="index.php?act=payment.php">
                ...
                <div class="input-group">
                    ...
                    <input type="tel" name="phoneNumber_user" pattern="\d*" required>
                </div>
                <div class="input-group">
                ...
                <div class="input-group" style="border: none; margin-top: 10px;">
                    <a href="index.php?act=bill">
                        <button type="submit" name="billcomfirm">Payment</button>
                    </a>
                </div>
            </form>
        </div>
